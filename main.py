                ...
                while True:
                    try:
                        if self.continue_dtc:
                            ...
                            #     for confidence, class_id, tracker_id in zip(confidences, class_ids, tracker_ids)
                            # ]
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        UIFuncitons.shadow_style(self, self.Class_QF, QColor(149,132,193))
        UIFuncitons.shadow_style(self, self.Target_QF, QColor(149,132,193))
        UIFuncitons.shadow_style(self, self.Fps_QF, QColor(149,132,193))
        UIFuncitons.shadow_style(self, self.Model_QF, QColor(149,132,193))
    ...
    def load_config(self):
        ...
        self.run_button.setChecked(False)  
        self.show_status("欢迎使用智能交通路况分析系统")
